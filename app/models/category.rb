...
class Category < ActiveRecord::Base
  ...
  def Category.add_initial_categories_for_user(user_id)
    ...
    liabilities1= Category.create!(:name => "カード払い",         :parent_category_id => liabilities.id, :user_id => user_id, :category_type => CategoryType::LIABILITIES, :is_creditor => true, :shortcut => "151", :display_order => 251)
    liabilities2= Category.create!(:name => "借金",               :parent_category_id => liabilities.id, :user_id => user_id, :category_type => CategoryType::LIABILITIES, :is_creditor => true, :shortcut => "152", :display_order => 252)
    liabilities3= Category.create!(:name => "ローン",             :parent_category_id => liabilities.id, :user_id => user_id, :category_type => CategoryType::LIABILITIES, :is_creditor => true, :shortcut => "153", :display_order => 253)
