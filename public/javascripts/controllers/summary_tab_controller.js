...
kakeibo.controller.SummaryTabController.prototype.initTables = function(){
	this.m_pl_table_view = new kakeibo.component.SummaryTableView({
		...
		show_budgets: true,
		header_format_year : $("#summary-pane-grid-header-format").attr("data-format-year"),
		header_format_month : $("#summary-pane-grid-header-format").attr("data-format-month")
	});
...
kakeibo.controller.SummaryTabController.prototype.initChart = function(){
	...
	var onclick = function(target){
		...
		var chart_name = $target.attr("data-chart");
		...
		var categories = [];
		var data_type = $target.attr("data-chart-category");
		var column_type;
